...
- `git push` works within the sandbox via HTTPS (`url.insteadOf` rewrites SSH to HTTPS, `gh auth git-credential` provides tokens). See `docs/adr/0003-https-migration-remove-allowAllUnixSockets.md`
