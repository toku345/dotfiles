...
C03 applies only to agent-launched commands. For each runtime, occurrence, address family, protocol, and destination class, the harness creates an independent target record.
