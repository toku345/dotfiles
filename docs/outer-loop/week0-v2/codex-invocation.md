...
| `CP2_READY` | Ensure the agent has yielded, expire authority, prove complete execution-group quiescence, and run the identical postflight collector; only a complete passing role gate may freeze the canonical snapshot and proceed to independent review |
