...
- **Chezmoi Source Edits**: `~/.local/share/chezmoi/` 配下の source 編集（dotfile 管理の本懐）。default の Self-Modification を waive。新規 `run_*` script・SSH 鍵・外部 fetch surface 追加は hard carve-out (a)–(d) として default 評価へ
