...
ただし auto-mode は分類器ベースで tool call を auto-approve する仕様 (公式 docs: <https://code.claude.com/docs/en/permissions>)。本ファイルは hard override ではなく、**Claude 自身の意思決定と分類器の双方への入力** として作用する (公式 docs: "steers both Claude and the classifier")。
