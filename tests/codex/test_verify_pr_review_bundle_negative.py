...
def main() -> None:
    mutations = [
        ...
        (
            ...
            '"retired_after_presence"',
            "V2 scheduler contract mismatch",
        ),
        (
            "V2 retirement full-tree requirement removed",
            "private_dot_codex/skills/pr-review/references/v2-runtime-contract.json",
            '"retirement_requires_successful_full_tree_snapshot": true',
            '"retirement_requires_successful_full_tree_snapshot": false',
            "V2 scheduler contract mismatch",
        ),
        (
            "V2 parent-interrupt exclusion removed",
            "private_dot_codex/skills/pr-review/references/v2-runtime-contract.json",
        ...
        (
            "V2 reconciliation order changed",
            "private_dot_codex/skills/pr-review/references/v2-runtime-contract.json",
        ...
        (
            "V2 cleanup monotonicity removed",
            "private_dot_codex/skills/pr-review/references/v2-runtime-contract.json",
            '"cleanup_is_monotonic_fatal": true',
            '"cleanup_is_monotonic_fatal": false',
            "V2 scheduler contract mismatch",
        ),
        (
        ...
        (
            ...
            "Refill immediately after the first delivered result",
            "Never refill between those steps",
        ),
        (
